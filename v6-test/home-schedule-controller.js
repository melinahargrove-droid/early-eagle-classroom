...
function schedule(){try{const x=JSON.parse(localStorage.getItem(SCHEDULE_KEY)||'null');if(Array.isArray(x)&&x.length)return x.filter(i=>i&&i.active!==false)}catch(e){}return []}
